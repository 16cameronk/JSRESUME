   ...
   var initProgram = setTimeout(function(){
       ...
       var message = "RUNNING  RESUME PROTOCAL (CRP) FOR CAMERON KING";
       var $identityDiv = $("#identity-results");
       var $name = "NAME: CAMERON";
       var $alias = "KNOWN ALIAS: YTHAN KING"
       var $occupation  = "OCCUPATION: FRONT END DEVELOPER | GAME DEVLOPER | GRAPHIC DESIGNER | ATHLETE | MUSICIAN";
       var $frontEnd  = "FRONT END DEVELOPMENT CORE: HTML5 | CSS3 | JAVASCRIPT";
         var $JSFrameworks = "JAVASCRIPT FRAMEWORKS: METEOR JS";
         var $JSLibs = "JAVASCRIPT LIBRARIES: JQUERY | ANGULAR ";
	   ...
	   var $frontEndAnimation = "MUSICAL INSTRUMENTS: PIANO | DRUMS | TRUMPET | BARITONE HORN"
